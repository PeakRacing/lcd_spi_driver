...
#ifdef PKG_USING_LCD_SPI_DRIVER
...
#elif defined PKG_LCD_SPI_USING_LCD_ILI9341
static void lcd_ili9341_init(){
    lcd_write_cmd_data(0xCF, (uint8_t[]){0x00,0xD9,0x30}, 3);
    lcd_write_cmd_data(0xED, (uint8_t[]){0x64,0x03,0x12,0x81}, 4);
    lcd_write_cmd_data(0xE8, (uint8_t[]){0x85,0x10,0x78}, 3);
    lcd_write_cmd_data(0xCB, (uint8_t[]){0x39,0x2C,0x00,0x34,0x02}, 5);
    lcd_write_cmd_data(0xF7, (uint8_t[]){0x20}, 1);
    lcd_write_cmd_data(0xEA, (uint8_t[]){0x00,0x00}, 2);
    lcd_write_cmd_data(0xC0, (uint8_t[]){0x21}, 1);
    lcd_write_cmd_data(0xC1, (uint8_t[]){0x12}, 1);
    lcd_write_cmd_data(0xC5, (uint8_t[]){0x32,0x3C}, 2);
    lcd_write_cmd_data(0xC7, (uint8_t[]){0xC1}, 1);
    lcd_write_cmd_data(0xC5, (uint8_t[]){0x1A}, 1);
    lcd_write_cmd_data(0xB1, (uint8_t[]){0x00,0x18}, 2);
    lcd_write_cmd_data(0xB6, (uint8_t[]){0x0A,0xA2}, 2);
    lcd_write_cmd_data(0xF2, (uint8_t[]){0x00}, 1);
    lcd_write_cmd_data(0x26, (uint8_t[]){0x01}, 1);
    lcd_write_cmd_data(0xE0, (uint8_t[]){0x0F,0x20,0x1E,0x09,0x12,0x0B,0x50,0xBA,0x44,0x09,0x14,0x05,0x23,0x21,0x00}, 15);
    lcd_write_cmd_data(0xE1, (uint8_t[]){0x00,0x19,0x19,0x00,0x12,0x07,0x2D,0x28,0x3F,0x02,0x0A,0x08,0x25,0x2D,0x0F}, 15);
}
#elif defined PKG_LCD_SPI_USING_LCD_ILI9486
static void lcd_ili9486_init(){
    lcd_write_cmd_data(0xE0, (uint8_t[]){0x00,0x07,0x0f,0x0D,0x1B,0x0A,0x3c,0x78,0x4A,0x07,0x0E,0x09,0x1B,0x1e,0x0f}, 15);
    lcd_write_cmd_data(0xE1, (uint8_t[]){0x00,0x22,0x24,0x06,0x12,0x07,0x36,0x47,0x47,0x06,0x0a,0x07,0x30,0x37,0x0f}, 15);
    lcd_write_cmd_data(0xC0, (uint8_t[]){0x10,0x10}, 2);
    lcd_write_cmd_data(0xC1, (uint8_t[]){0x41}, 1);
    lcd_write_cmd_data(0xC5, (uint8_t[]){0x00,0x22,0x80}, 3);
    lcd_write_cmd_data(0xB0, (uint8_t[]){0x00}, 1);
    lcd_write_cmd_data(0xB1, (uint8_t[]){0xB0,0x11}, 2);
    lcd_write_cmd_data(0xB4, (uint8_t[]){0x02}, 1);
    lcd_write_cmd_data(0xB6, (uint8_t[]){0x02,0x02}, 2);
    lcd_write_cmd_data(0xB7, (uint8_t[]){0xC6}, 1);
    lcd_write_cmd_data(0xE9, (uint8_t[]){0x00}, 1);
    lcd_write_cmd_data(0xF7, (uint8_t[]){0xA9,0x51,0x2C,0x82}, 4);
}
#elif defined PKG_LCD_SPI_USING_LCD_GC9A01
static void lcd_gc9a01_init(){
    lcd_write_cmd(0xEF);
    lcd_write_cmd_data(0xEB, (uint8_t[]){0x14}, 1);
    lcd_write_cmd(0xFE);
    lcd_write_cmd(0xEF);
    lcd_write_cmd_data(0xEB, (uint8_t[]){0x14}, 1);
    lcd_write_cmd_data(0x84, (uint8_t[]){0x40}, 1);
    lcd_write_cmd_data(0x85, (uint8_t[]){0xFF}, 1);
    lcd_write_cmd_data(0x86, (uint8_t[]){0xFF}, 1);
    lcd_write_cmd_data(0x87, (uint8_t[]){0xFF}, 1);
    lcd_write_cmd_data(0x88, (uint8_t[]){0x0A}, 1);
    lcd_write_cmd_data(0x89, (uint8_t[]){0x21}, 1);
    lcd_write_cmd_data(0x8A, (uint8_t[]){0x00}, 1);
    lcd_write_cmd_data(0x8B, (uint8_t[]){0x80}, 1);
    lcd_write_cmd_data(0x8C, (uint8_t[]){0x01}, 1);
    lcd_write_cmd_data(0x8D, (uint8_t[]){0x01}, 1);
    lcd_write_cmd_data(0x8E, (uint8_t[]){0xFF}, 1);
    lcd_write_cmd_data(0x8F, (uint8_t[]){0xFF}, 1);
    lcd_write_cmd_data(0xB6, (uint8_t[]){0x00,0x20}, 2);
    lcd_write_cmd_data(0x3A, (uint8_t[]){0x05}, 1);
    lcd_write_cmd_data(0x90, (uint8_t[]){0x08,0x08,0x08,0x08}, 4);
    lcd_write_cmd_data(0xBD, (uint8_t[]){0x06}, 1);
    lcd_write_cmd_data(0xBC, (uint8_t[]){0x00}, 1);
    lcd_write_cmd_data(0xFF, (uint8_t[]){0x60,0x01,0x04}, 3);
    lcd_write_cmd_data(0xC3, (uint8_t[]){0x13}, 1);
    lcd_write_cmd_data(0xC4, (uint8_t[]){0x13}, 1);
    lcd_write_cmd_data(0xC9, (uint8_t[]){0x22}, 1);
    lcd_write_cmd_data(0xBE, (uint8_t[]){0x11}, 1);
    lcd_write_cmd_data(0xE1, (uint8_t[]){0x10,0x0E}, 2);
    lcd_write_cmd_data(0xDF, (uint8_t[]){0x21,0x0c,0x02}, 3);
    lcd_write_cmd_data(0xF0, (uint8_t[]){0x45,0x09,0x08,0x08,0x26,0x2A}, 6);
    lcd_write_cmd_data(0xF1, (uint8_t[]){0x43,0x70,0x72,0x36,0x37,0x6F}, 6);
    lcd_write_cmd_data(0xF2, (uint8_t[]){0x45,0x09,0x08,0x08,0x26,0x2A}, 6);
    lcd_write_cmd_data(0xF3, (uint8_t[]){0x43,0x70,0x72,0x36,0x37,0x6F}, 6);
    lcd_write_cmd_data(0xED, (uint8_t[]){0x1B,0x0B}, 2);
    lcd_write_cmd_data(0xAE, (uint8_t[]){0x77}, 1);
    lcd_write_cmd_data(0xCD, (uint8_t[]){0x63}, 1);
    lcd_write_cmd_data(0x70, (uint8_t[]){0x07,0x07,0x04,0x0E,0x0F,0x09,0x07,0x08,0x03}, 8);
    lcd_write_cmd_data(0xE8, (uint8_t[]){0x34}, 1);
    lcd_write_cmd_data(0x62, (uint8_t[]){0x18,0x0D,0x71,0xED,0x70,0x70,0x18,0x0F,0x71,0xEF,0x70,0x70}, 12);
    lcd_write_cmd_data(0x63, (uint8_t[]){0x18,0x11,0x71,0xF1,0x70,0x70,0x18,0x13,0x71,0xF3,0x70,0x70}, 12);
    lcd_write_cmd_data(0x64, (uint8_t[]){0x28,0x29,0xF1,0x01,0xF1,0x00,0x07}, 7);
    lcd_write_cmd_data(0x66, (uint8_t[]){0x3C,0x00,0xCD,0x67,0x45,0x45,0x10,0x00,0x00,0x00}, 10);
    lcd_write_cmd_data(0x67, (uint8_t[]){0x00,0x3C,0x00,0x00,0x00,0x01,0x54,0x10,0x32,0x98}, 10);
    lcd_write_cmd_data(0x74, (uint8_t[]){0x10,0x85,0x80,0x00,0x00,0x4E,0x00}, 7);
    lcd_write_cmd_data(0x98, (uint8_t[]){0x3e,0x07}, 2);
    lcd_write_cmd(0x35);
}
